...
from yahoobeautifulsoup import config
import re
import pandas as pd
import numpy as np
...
class YahooScraper():
    ...
    async def scrape_currencies(self, file_name):
        ...
        return self.load_excel_from_pd(currencies, file_name)



    def load_excel_from_pd(self,df, file_name):
